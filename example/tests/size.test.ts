...
describe("CandyShared value size of rust and motoko libraries should be NOT equal", () => {
    ...
    test("Int", async () => {
        ...
        expect(rustSize).toBe(BigInt(212));
    ...
    test("Int8", async () => {
        ...
        expect(rustSize).toBe(BigInt(207));
    ...
    test("Int16", async () => {
        ...
        expect(rustSize).toBe(BigInt(208));
    ...
    test("Int64", async () => {
        ...
        expect(rustSize).toBe(BigInt(214));
    ...
    test("Nat", async () => {
        ...
        expect(rustSize).toBe(BigInt(211));
        expect(motokoSize).toBe(BigInt(6));
    });
    ...
    test("Text", async () => {
        ...
        expect(rustSize).toBe(BigInt(220));
    ...
    test("Blob", async () => {
        ...
        expect(rustSize).toBe(BigInt(215));
    ...
    test("Class", async () => {
        ...
        expect(rustSize).toBe(BigInt(224));
    ...
    test("Principal", async () => {
        ...
        expect(rustSize).toBe(BigInt(218));
    ...
    test("Option", async () => {
        ...
        expect(rustSize).toBe(BigInt(209));
        expect(motokoSize).toBe(BigInt(5));
    });
    ...
    test("Floats", async () => {
        ...
        expect(rustSize).toBe(BigInt(263));
    ...
    test("Map", async () => {
        ...
        const motokoSize = await motokoCanister.sizeOfCandyValueMap();
        expect(rustSize).toBe(BigInt(211));
        expect(motokoSize).toBe(BigInt(8));
    });
